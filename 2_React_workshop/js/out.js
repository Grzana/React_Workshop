...
var _searchbar = __webpack_require__(/*! ./searchbar.jsx */ "./js/searchbar.jsx");

var _searchbar2 = _interopRequireDefault(_searchbar);

var _cattable = __webpack_require__(/*! ./cattable.jsx */ "./js/cattable.jsx");
...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.filterText = function (childInfo) {
            _this.setState({ filterText: childInfo });
        };

        _this.filterCheck = function (childInfo) {
            _this.setState({ likesKids: childInfo });
        };
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_searchbar2.default, { onTextChange: this.filterText, onCheckChange: this.filterCheck, filterText: this.state.filterText, likesKids: this.state.likesKids }),
                _react2.default.createElement(_cattable2.default, { filterText: this.state.filterText, likesKids: this.state.likesKids, kitties: kitties })
            );
        }
    }]);
...
var _categoryrow = __webpack_require__(/*! ./categoryrow.jsx */ "./js/categoryrow.jsx");

var _categoryrow2 = _interopRequireDefault(_categoryrow);

var _catrow = __webpack_require__(/*! ./catrow.jsx */ "./js/catrow.jsx");
        ...
        value: function render() {
            ...
            this.props.kitties.forEach(function (kitty) {
                if (kitty.category !== lastCategory) {
                    ...
                    rows.push(_react2.default.createElement(_categoryrow2.default, { category: kitty.category, key: kitty.category })); //dodaj do tablicy rows komponent CatCategoryRow
                }
                switch (_this2.props.likesKids) {
                    case true:
                        if (kitty.likesKids && kitty.name.indexOf(_this2.props.filterText) !== -1) {
                            rows.push(_react2.default.createElement(_catrow2.default, { kitty: kitty, key: kitty.name })); //dodaj do tablicy rows komponent CatRow (waruenk filtr dziecka i tekstu w name)
                        }
                        break;
                    case false:
                        if (kitty.name.indexOf(_this2.props.filterText) !== -1) {
                            rows.push(_react2.default.createElement(_catrow2.default, { kitty: kitty, key: kitty.name })); //dodaj do tablicy rows komponent CatRow (waruenk filtr dziecka i tekstu w name)
                        }
                        break;
                }
...
var SearchBar = function (_React$Component) {
    ...
    function SearchBar() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SearchBar.__proto__ || Object.getPrototypeOf(SearchBar)).call.apply(_ref, [this].concat(args))), _this), _this.sendTextInfo = function (e) {
            if (typeof _this.props.onTextChange === 'function') {
                _this.props.onTextChange(e.target.value);
            }
        }, _this.sendCheckInfo = function (e) {
            if (typeof _this.props.onCheckChange === 'function') {
                _this.props.onCheckChange(e.target.checked);
    ...
    _createClass(SearchBar, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'form',
                null,
                _react2.default.createElement('input', { onChange: this.sendTextInfo, value: this.props.filterText,
                    type: 'text', placeholder: 'Search...' }),
                _react2.default.createElement(
                    'p',
                    null,
                    _react2.default.createElement('input', { onChange: this.sendCheckInfo, checked: this.props.likesKids,
                        type: 'checkbox' }),
